        ...
        if(this.props.data !== undefined && this.props.data !== null){
           return(
            <Modal visible={this.props.visibile}  animationType={'slide'}  onRequestClose={() => {console.log("Modal close")}}>
                ...
                {(this.props.data !== null && this.props.data !== undefined && this.props.data.paid && !this.props.data.order_verify) ? (<Button full primary rounded style={{margin:10}}  onPress={() => this.props.bill(this.props.data)}>
                    <Text style={{color:'rgb(255,255,255)'}}>Verify Bill</Text>
                </Button>):null}
            </Modal>
